  ...
  return (
    <div className="landingcont">
      ...
      <div className="landtxt1">
        <div id="landtxt1i">
          <h1>
            GETBIT P2P Crypto <br /> Exchange{" "}
          </h1>
          <p>
            Buy and Sell Usdt,Bitcoin,Ethereum and more with <br /> your bank
            account + 10 other payment methods.
          </p>
        </div>
      </div>
      ...
      <div className="landtxt2">
        <div className="landtxt2i">
          ...
          <h5>
            Getbit Peer to Peer Trading platform is 100% safe, <br /> You can
            set your own price per coin for others to <br /> buy or sell from
            you. Crypto coins are escrowed to <br /> ensure security and fast
            settlements.
          </h5>
        </div>
      </div>
      ...
      <div id="starttrade">
        <div className="starttrade1">
          ...
          <p>
            Sign up for free to start buying and selling bitcoin and other
            crypto coins on <br />
            Getbit in real time.
          </p>
      ...
      <div className="landlastimg">
        <div className="landlastimg1">
          <h1>
            We won’t toot our horns; <br /> Our users do that for us.
          </h1>
        </div>
      </div>
      <Footer />
